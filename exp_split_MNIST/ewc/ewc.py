...
# Fisher information
model.save_omega1(sess,data01["data"], batch_size=1000,keep_prob=1.0)  # save recent task Fisher matrix
# save current optimal weights
model.star()


acc2=train_task2(model,50,5, data23, [test23], x,y2,keep_prob,lams=[0,10])
print("2th task acc:",acc2[0][-1])
model.save_omega2(sess, data23["data"], batch_size=1000,keep_prob=1.0)
model.star()


acc3=train_task3(model,50,5,data45, [test45], x,y3,keep_prob,lams=[0,10])
print("3th task acc:",acc3[0][-1])
model.save_omega3(sess, data45["data"], batch_size=1000,keep_prob=1.0)
model.star()


acc4=train_task4(model,50,5, data67, [test67], x,y4,keep_prob,lams=[0,10])
print("4th task acc:",acc4[0][-1])
model.save_omega4(sess, data67["data"],batch_size=1000,keep_prob=1.0)
model.star()

acc5=train_task5(model,50,5, data89, [test01,test23,test45,test67,test89], x,y1,y2,y3,y4,y5,keep_prob,lams=[0,10])
...
print("ACC：",ACC5)
model.save_omega5(sess, data89["data"],batch_size=1000,keep_prob=1.0)
model.star()
