...
acc2=train_task2(model,50,5, data23, [test23], x,y2,keep_prob,lams=[0])
print("2th task acc:",acc2[0][-1])
model.star()

acc3=train_task3(model,50,5,data45, [test45], x,y3,keep_prob,lams=[0])
print("3th task acc:",acc3[0][-1])
model.star()

acc4=train_task4(model,50,5, data67, [test67], x,y4,keep_prob,lams=[0])
print("4th task acc:",acc4[0][-1])
model.star()


acc5=train_task5(model,50,5, data89, [test01,test23,test45,test67,test89], x,y1,y2,y3,y4,y5,keep_prob,lams=[0])
